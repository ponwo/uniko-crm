...
| `026-conector-inventario` | Ciclo completo | spec, plan, research, data-model, 2 contratos, quickstart, checklist, tasks — conector `INVENTARIO` (bandera): botón "Inventario" con SSO al portal de MS-Stock y acción `check_stock` del agente; el contrato vive en el repo MS-Stock (feature 003). El número 025 quedó sin usar (el script de ramas lo saltó el 2026-09-12); no se reasigna |

...
const globalForBus = globalThis as unknown as { __unikoBus?: EventEmitter };

function getBus(): EventEmitter {
  if (!globalForBus.__unikoBus) {
    const bus = new EventEmitter();
    bus.setMaxListeners(200);
    globalForBus.__unikoBus = bus;
  }
  return globalForBus.__unikoBus;
}

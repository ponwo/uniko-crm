---
name: uniko-promote
description: Ejecuta la puerta de promoción a producción de la constitución (main → production): verifica las seis condiciones, resume y se detiene SIN promover. Úsalo cuando se vaya a soltar un cambio a las instancias de clientes.
compatibility: Requiere .specify/ y las herramientas git, curl y gh
metadata:
  author: uniko-crm
  source: uniko:commands/uniko.promote.md
---
...
- Puerta de promoción y sus seis condiciones: `.specify/memory/constitution.md`,
...
- Mecánica de ramas, dominios de la flota y healthchecks:
  `docs/despliegue-flota.md`.
- Fuente de esta skill: `.specify/extensions/uniko/commands/uniko.promote.md`.

# Uniko CRM — Guía para Asistente de IA

Uniko CRM es un CRM de WhatsApp self-hosted con agente de IA y
Laboratorio de auto-evaluación. Una instancia = un negocio. Este archivo guía a
asistentes de IA para operar y modificar este repositorio.

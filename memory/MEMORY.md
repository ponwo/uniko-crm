...
- [Respuesta por talla (028) — PR #31](respuesta-por-talla-028-pr31.md) — mergeada y desplegada el 2026-09-16 (4d3662f), verificada por WhatsApp con los 4 modelos reales el 2026-09-17 (cierra la T057); pendiente de decidir el orden de llegada de las fotos (Meta reordena imágenes por URL); NO promovida; gotchas del arnés: base nueva por corrida, calentar rutas, no resetear el outbox

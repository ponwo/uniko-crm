...
- [Plantillas 027: espejo de Meta y errores con causa](plantillas-027-espejo-de-meta.md) — en main (8df60b5) y verificada en uniko-lanco el 2026-09-15 (importó hello_world; crear tardó >8 s en Meta y respondió 201); el error del dueño era el fallback no-JSON; uniko.lanco.cloud va por Cloudflare; pendiente promover a production

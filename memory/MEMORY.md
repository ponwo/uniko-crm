...
- [Plantillas 027: espejo de Meta y errores con causa](plantillas-027-espejo-de-meta.md) — el error del dueño era el fallback no-JSON de la pantalla; uniko.lanco.cloud SÍ va por Cloudflare; PR con migración 0015 pendiente de ensayo X y verificación en vivo

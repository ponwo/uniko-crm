...
- [Foto del producto (026) — PR #28](foto-producto-026-pr28-pendiente.md) — en main y en uniko-lanco desde el 2026-09-14, T048 cerrada con la verificación del dueño; no promovida a production; decisiones de diseño fuera del contrato; el camino feliz no escribe en el log

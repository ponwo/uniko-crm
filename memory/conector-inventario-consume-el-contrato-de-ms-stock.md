...
El dueño verificó el flujo real en la instancia de pruebas el 2026-09-12
(existencia y precio; agotado con precio). **Promovida a `production` el 2026-09-14
en `8d91b78`** (con la foto y las tallas); las instancias de clientes siguen con
`INVENTARIO` apagada (sin bandera ni `STOCK_*` en su Coolify).
